...
<div class="d-flex flex-column flex-root" style="overflow: hidden" id="kt_app_root">
    <div class="d-flex flex-column flex-lg-row flex-column-fluid">
        ...
        <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-2 bg-white">

            <div class="d-flex flex-center flex-column flex-lg-row-fluid">

                <div class="w-lg-500px p-10">

                    <form class="form w-100" novalidate="novalidate" id="auditor_sign_in_form"
                        action="{{ route('auditor.login') }}" method="POST">
                        @csrf
                        ...
                        <div class="d-grid mb-10">
                            <button type="submit" id="auditor_sign_in_submit" class="btn btn-warning">
...
@include('components.dashboard.authauditor')
